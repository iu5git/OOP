...
> Важно:
> - исходный код работает только с `char*`;
> - необходимо:
>   - сделать классы шаблонными (`template <typename T>`);
>   - реализовать поддержку различных типов данных;
>   - реализовать специализацию для char* (с учётом особенностей сравнения и добавления строк). Запрещено специализировать полностью класс. Необходимо специализировать определённые методы
