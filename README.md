...
- В данной лабораторной работе обязательно использование идиомы [copy-and-swap](https://fitoliaka.github.io/OOP/Style%20Guide.html#идиома-copy-and-swap-в-c) при реализации оператора присваивания.
...
- При добавлении элементов контролировать переполнение массива и если надо предусмотреть возможность его расширить.
- При удалении элементов обеспечивать корректное смещение массива.
- Для сортировки использовать свою библиотеку.
