...
Темы для проекта приведены в приложении 1. Если ни одна из предложенных тем не подходит, можно выбрать свою, ориентируясь на темы:
...
16-17 неделя. Сдать в электронном виде отчёт по практике.
...
Титульный лист представлен в Приложении 2.
